    ...
    public void start(Stage primaryStage) throws FileNotFoundException {
        ...
        if (spins <= 0){
            Stage endStage = new Stage();
                ...
                Group eroot = new Group();
                Scene escene = new Scene(eroot, 300, 150);
        
                Label gameOver = new Label("Game Over");
                gameOver.setLayoutX(50);
                gameOver.setLayoutY(100);
                        
                Label endGameScore = new Label("You Won " + MainMethod.player1.getScore() + " in Cash ans Prizes");
                endGameScore.setLayoutX(150);
                endGameScore.setLayoutY(100);
                      
                eroot.getChildren().add(gameOver);
                eroot.getChildren().add(endGameScore);
                
                primaryStage.close();
                endStage.setTitle("Game Over");
                endStage.setScene(escene);
                endStage.show();
